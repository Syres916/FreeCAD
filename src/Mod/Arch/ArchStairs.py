...
def makeStairs(
    ...
    if stairs:
        ...
        for stair in stairs:
            stair.recompute()
            if FreeCAD.GuiUp and idx != 0:
                stair.Visibility = False
            idx += 1
        makeRailing(stairs)
    ...
    def execute(self, obj):
        ...
        if obj.RailingLeft:
            ...
            if railWireL:
                ...
                if FreeCAD.GuiUp:
                    railingLeftObject.Base.Visibility = False
            else:
        ...
        if obj.RailingRight:
            ...
            if railWireR:
                ...
                if FreeCAD.GuiUp:
                    railingRightObject.Base.Visibility = False
            else:
