...
class TestMultiTransformLegacy(unittest.TestCase):
    ...
    def testMultiTransform(self):
        ...
        self.geo0 = self.Sketch.addGeometry(Part.LineSegment(FreeCAD.Vector (0.0, 0.0, 0.0), FreeCAD.Vector (0.0, 23.837982, 0.0)))
        self.geo1 = self.Sketch.addGeometry(Part.LineSegment(FreeCAD.Vector (0.0, 23.837982, 0.0), FreeCAD.Vector (44.55508400000001, 23.837982, 0.0)))
        self.geo2 = self.Sketch.addGeometry(Part.LineSegment(FreeCAD.Vector (44.55508400000001, 23.837982, 0.0), FreeCAD.Vector (60.491337, 0.0, 0.0)))
        self.geo3 = self.Sketch.addGeometry(Part.LineSegment(FreeCAD.Vector (60.491337, 0.0, 0.0), FreeCAD.Vector (0.0, 0.0, 0.0)))
        self.Sketch.addConstraint(Sketcher.Constraint('Coincident', -1, 1, self.geo0, 1))
        self.Sketch.addConstraint(Sketcher.Constraint('PointOnObject', self.geo0, 2, -2))
        self.Sketch.addConstraint(Sketcher.Constraint('Coincident', self.geo0, 2, self.geo1, 1))
        self.Sketch.addConstraint(Sketcher.Constraint('Horizontal', self.geo1))
        self.Sketch.addConstraint(Sketcher.Constraint('Coincident', self.geo1, 2, self.geo2, 1))
        self.Sketch.addConstraint(Sketcher.Constraint('PointOnObject', self.geo2, 2, -1))
        self.Sketch.addConstraint(Sketcher.Constraint('Coincident', self.geo2, 2, self.geo3, 1))
        self.Sketch.addConstraint(Sketcher.Constraint('Coincident', self.geo3, 2, self.geo0, 1))
        ...
        self.geo0 = self.Sketch001.addGeometry(Part.LineSegment(FreeCAD.Vector (23.837981999999997, 2.9e-15, 0.0), FreeCAD.Vector (0.0, 45.000000000000014, 0.0)))
        self.geo1 = self.Sketch001.addGeometry(Part.LineSegment(FreeCAD.Vector (0.0, 45.000000000000014, 0.0), FreeCAD.Vector (40.116829, 51.757961, 0.0)))
        self.geo2 = self.Sketch001.addGeometry(Part.LineSegment(FreeCAD.Vector (40.116829, 51.757961, 0.0), FreeCAD.Vector (23.837981999999997, 0.0, 0.0)))
        ...
        self.Sketch001.addConstraint(Sketcher.Constraint('PointOnObject',2,2,-1))
        self.Sketch001.delConstraint(5)
        self.Sketch001.addConstraint(Sketcher.Constraint('DistanceY',-1,1,0,2,45.000000))
        self.Sketch001.setDatum(5,App.Units.Quantity('45.000000 mm'))
        self.Sketch001.addConstraint(Sketcher.Constraint('DistanceY',-1,1,1,2,51.757961))
        self.Sketch001.setDatum(6,App.Units.Quantity('51.760000 mm'))
        self.Sketch001.addConstraint(Sketcher.Constraint('DistanceX',-1,1,0,1,23.837982))
        self.Sketch001.setDatum(7,App.Units.Quantity('23.840000 mm'))
        self.Sketch001.addConstraint(Sketcher.Constraint('DistanceX',-1,1,1,2,40.116829))
        self.Sketch001.setDatum(8,App.Units.Quantity('40.120000 mm'))
        self.Sketch001.MapMode = 'FlatFace'
        self.Sketch001.Placement = FreeCAD.Placement(FreeCAD.Vector(0.00, 0.00, 0.00), FreeCAD.Rotation (0.5, 0.5, 0.5, 0.5))
        ...
        self.DatumPoint.Placement = FreeCAD.Placement(FreeCAD.Vector(36.29, 0.00, 45.00), FreeCAD.Rotation(FreeCAD.Vector(0.5773502691896257,0.5773502691896257,0.5773502691896257),120))
        ...
        self.DatumPlane.Placement = FreeCAD.Placement(FreeCAD.Vector(47.11, 7.95, 15.00), FreeCAD.Rotation (0.25639002138112243, 0.4798095739282281, 0.7400452731042549, 0.39544901499314516))
        self.DatumPlane.Support = [(self.DatumPoint, ('')), (self.Sketch, ('Vertex4', 'Vertex3'))]
        ...
        self.DatumPoint.Placement = FreeCAD.Placement(FreeCAD.Vector(36.2948022,0,4),FreeCAD.Rotation(FreeCAD.Vector(0.5773502691896257,0.5773502691896257,0.5773502691896257),120))
        self.DatumPoint.Placement = FreeCAD.Placement(FreeCAD.Vector(36.2948022,0,45),FreeCAD.Rotation(FreeCAD.Vector(0.5773502691896257,0.5773502691896257,0.5773502691896257),120))
