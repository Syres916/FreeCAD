    ...
    : QDialog(parent, fl)
{
    ...
    double customizeWindowRatio = 0.5;
    resize(maxWidth * customizeWindowRatio, maxHeight * customizeWindowRatio);
    ...
    tabWidget->setObjectName(
        QString::fromLatin1("Gui__Dialog__TabWidget"));  // so we can find it in DlgMacroExecuteImp
